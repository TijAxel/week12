...
vari=input("Please type a number: ")
eve=int(vari)
...
min=int(10)
Max=int(20)
print(f"your number is in the range of 10 and 20:{number>=min and number<=max}")
...
integer= input("Type any number ")
multiples_of_3=[3, 6, 9, 12, 15, 18, 21, 24, 27, 30]
print(str(integer in multiples_of_3 ))
# Input: A number (integer)
# Output:
